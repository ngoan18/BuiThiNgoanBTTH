...
namespace baithuchanh04.Controllers
{
    public class StudentController : Controller
    {
        ...
        {
            ViewData["EmployeeID"] = new SelectList(_context.Employee, "EmployeeID", "EmployeeFullName", "EmployeeID");
             var newID = "";
        ...
        public async Task<IActionResult> Create([Bind("StudentID,FullName,Address")] Student student)
        {
            ...
            ViewData["EmployeeID"] = new SelectList(_context.Employee, "EmployeeID", "EmployeeFullName", student.EmployeeID);
            return View(student);
        }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            if (student == null)
            {
             ...
             ViewData["EmployeeID"] = new SelectList(_context.Employee, "EmployeeID", "EmployeeID", student.EmployeeID);
            return View(student);
        }
