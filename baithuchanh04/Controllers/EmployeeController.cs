...
namespace baithuchanh04.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeID,EmployeeFullName,EmployeeAddress","CustomerID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("EmployeeID,EmployeeFullName,EmployeeAddress")] Employee employee)
        {
                ...
                else
                {
                    ...
                    using (var stream = new FileStream(filePath, FileMode.Create))
                    {
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            emp.EmployeeFullName = dt.Rows[i][1].ToString();
